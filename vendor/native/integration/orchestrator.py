...
from .contracts import PipelineInput,PipelineConfig,PipelineResult
from .errors import StageError
from .bridge import invoke
from .adapters.operation_adapter import build_operation

def fingerprint(value):
    return hashlib.sha256(json.dumps(value,sort_keys=True,ensure_ascii=False,allow_nan=False).encode()).hexdigest()

def run_lastplate_pipeline(input_data, *, config=None, hooks=None):
