...
class ServiceConfig:
    ...
    def __post_init__(self):
        ...
        if not isinstance(self.trusted_weather_sources,(tuple,list)) or any(not isinstance(s,str) or not s.strip() for s in self.trusted_weather_sources):
            raise ValueError('trusted_weather_sources must be a list/tuple of source identifiers')
        object.__setattr__(self,'trusted_weather_sources',tuple(self.trusted_weather_sources))
