...
class ApiTests(unittest.TestCase):
    def test_create_get_and_recalculate_operation_plan(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch.dict(os.environ, {"LASTPLATE_DATABASE_PATH": db_path}, clear=False):
                ...
                with TestClient(create_app()) as client:
                    ...
                    example_path = Path(__file__).resolve().parents[2] / "docs" / "examples" / "operation-plan-request.json"
